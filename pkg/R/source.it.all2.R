...
# Funktion
source.it.all2 <- function ( folder="p:/ZKD/development" , use.zkd.conv = TRUE , development = TRUE , development.only = FALSE , exclude = NULL ) {
...
# TEST
# source.it.all2 ( folder = "c:/temp/Temp29" , development = TRUE , development.only = FALSE )
# source.it.all2 ( exclude = "automateDataPreparation" )
